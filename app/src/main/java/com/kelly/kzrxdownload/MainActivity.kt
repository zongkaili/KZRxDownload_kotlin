    ...
    inner class Presenter {
        fun onClick(view: View) {
            when (view.id) {
                ...
                R.id.single_task_download -> startActivity(Intent(this@MainActivity, MainActivity::class.java))
                R.id.multi_task_download -> startActivity(Intent(this@MainActivity, MainActivity::class.java))
            }
        }
    }
