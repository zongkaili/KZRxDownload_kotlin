...
import com.kelly.kzrxdownload.ui.NumberProgressBar.ProgressTextVisibility.Invisible
import com.kelly.kzrxdownload.ui.NumberProgressBar.ProgressTextVisibility.Visible
...
class NumberProgressBar @JvmOverloads constructor(context: Context, attrs: AttributeSet = null!!, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    override fun onRestoreInstanceState(state: Parcelable) {
        if (state is Bundle) {
            ...
            setProgressTextVisibility(if (bundle.getBoolean(INSTANCE_TEXT_VISIBILITY)) Visible else Invisible)
